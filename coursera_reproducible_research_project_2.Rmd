...
The following chart shows the types of storms that cause the greatest damages in United States dollars. Only the top ten types are shown. Tornadoes/thunderstorm wind/hail his is by far the most costly.
```{r}
